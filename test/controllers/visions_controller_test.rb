...
class VisionsControllerTest < ActionController::TestCase
  ...
  test "should create vision" do
    assert_difference('Vision.count') do
      post :create, vision: { dreamjob: @vision.dreamjob, industry: @vision.industry, style: @vision.style, ten: @vision.ten }
    end
  ...
  test "should update vision" do
    patch :update, id: @vision, vision: { dreamjob: @vision.dreamjob, industry: @vision.industry, style: @vision.style, ten: @vision.ten }
    assert_redirected_to vision_path(assigns(:vision))
  end
