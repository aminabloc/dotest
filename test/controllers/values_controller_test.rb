...
class ValuesControllerTest < ActionController::TestCase
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post :create, value: { howserve: @value.howserve, legacy: @value.legacy, whoserve: @value.whoserve }
    end
  ...
  test "should update value" do
    patch :update, id: @value, value: { howserve: @value.howserve, legacy: @value.legacy, whoserve: @value.whoserve }
    assert_redirected_to value_path(assigns(:value))
  end
