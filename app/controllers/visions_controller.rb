class VisionsController < ApplicationController
  ...
  # GET /visions/new
  def new
    @vision = current_user.vision.build
  end
  ...
  # POST /visions.json
  def create
    @vision = current_user.vision.build(vision_params)

    respond_to do |format|
      if @vision.save
        format.html { redirect_to new_value_path, notice: 'Vision was successfully created.' }
